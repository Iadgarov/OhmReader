...
import com.iadgarov.david.ohmreader.Resistor.Band;
import com.iadgarov.david.ohmreader.Resistor.BandWrapper;
import com.iadgarov.david.ohmreader.Resistor.Resistor;
import com.iadgarov.david.ohmreader.Visual.ButtonBand;
import com.iadgarov.david.ohmreader.Visual.ColorButtonListViewAdapter;
import com.iadgarov.david.ohmreader.Visual.ImageBand;
import com.iadgarov.david.ohmreader.Visual.VisualBand;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static TextView bandCountBanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s = (Switch)findViewById(R.id.visualToggle);
    ...
    private void initSeekBar(){
        ...
        bandCountBanner = ((TextView)findViewById(R.id.bandCount));

        bandCounter = ((SeekBar)findViewById(R.id.bandCountSlider));
        ((TextView)findViewById(R.id.bandCount)).setText(Integer.toString(bandCounter.getProgress() + 3) + " Band Resistor");
        bandCounter.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                bandCountBanner.setText(Integer.toString(progress + 3) + " Band Resistor");
            }
    ...
    private void updateBandCount(String value){
        ...
        if (resistor == null || resistor.getBands().size() != bandCount || resistor.getBands().size() == 4) {
            try {
    ...
    public static TextView getPinPoint(){
        return bandCountBanner;
    }
