...
public abstract class VisualBand{
    ...
    public void popUpColorMenu(){
        ...
        PopupMenu popup = new PopupMenu(MainActivity.appContext, MainActivity.getPinPoint());
        ...
        for (BandColor c : this.band.getColorList()) {
            ...
            MenuItem temp = popup.getMenu().add(c.toString() + "   (" + this.band.m_toString(c) + ")");
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                VisualBand.this.changeColor(BandColor.valueOf(item.getTitle().toString().split(" ")[0]));
                return true;
            }
        });
